...
st.markdown("### Divan Edebiyatı Mazmunları Araştırma Aracı", unsafe_allow_html=True)

arama = st.text_input("🔍 Mazmun ara:", "", key="main")

st.caption("Geliştiren: **Ayşe GÜLMEZ**")

# Buraya mazmun kodunu ekleyeceğiz
st.markdown("""
<style>
    .stApp {
    ...
    /* Yazılar için kontrast */
    h1, h2, h3, p, .stMarkdown, .st-emotion-cache {
